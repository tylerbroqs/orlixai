...
// ── banner ────────────────────────────────────────────────────────────────────
// DarkSOL-style: amber background blocks (filled cells like pixel art)
const BG = '\x1b[48;5;215m'; // amber background
const X = `${BG}  ${A.reset}`; // lit pixel  (2-char wide amber block)
const _ = '  '; // dark pixel (2-char wide space)
const BANNER = [
  '',
  `  ${_}${X}${X}${X}${_}${_}${_}${X}${X}${X}${X}${_}${_}${_}${X}${_}${_}${_}${_}${_}${_}${_}${_}${_}${X}${X}${X}${X}${X}${_}${X}${_}${_}${_}${_}${X}`,
  `  ${X}${_}${_}${_}${X}${_}${X}${_}${_}${_}${_}${X}${_}${X}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${X}${_}${_}${_}${X}${_}${_}${_}${_}${X}`,
  `  ${X}${_}${_}${_}${X}${_}${X}${_}${_}${_}${_}${X}${_}${X}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${X}${_}${_}${_}${_}${_}${X}${_}${X}${_}`,
  `  ${X}${_}${_}${_}${X}${_}${X}${X}${X}${X}${_}${_}${_}${X}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${X}${_}${_}${_}${_}${_}${_}${X}${_}${_}`,
  `  ${X}${_}${_}${_}${X}${_}${X}${_}${_}${X}${_}${_}${_}${X}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${X}${_}${_}${_}${_}${_}${X}${_}${X}${_}`,
  `  ${X}${_}${_}${_}${X}${_}${X}${_}${_}${_}${X}${_}${_}${X}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${_}${X}${_}${_}${_}${X}${_}${_}${_}${_}${X}`,
  `  ${_}${X}${X}${X}${_}${_}${X}${_}${_}${_}${_}${X}${_}${X}${X}${X}${X}${X}${_}${X}${X}${X}${X}${X}${_}${X}${_}${_}${_}${X}${_}${_}${_}${_}${X}`,
  '',
].join('\n');
